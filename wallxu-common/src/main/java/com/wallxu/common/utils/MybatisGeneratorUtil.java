...
import static com.wallxu.common.utils.StringUtil.lineToHump;

/**
 * 代码生成类
 * Created by ZhangShupinyougou on 2017/1/10.
 */
public class MybatisGeneratorUtil {
	...
	public static void generator(
		...
		if (os.toLowerCase().startsWith("win")) {
			...
			//自己处理下basePath，不取本项目目录了，改为取上级目录
			basePath = basePath.replaceFirst("/", "").substring(0,basePath.lastIndexOf("/"));
